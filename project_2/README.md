...
This repository is organized into the following directories for manufacturing and documentation:

* **`project_02/`**: Root directory containing the project documentation.
    * `Schematic.pdf`: Printable PDF version of the circuit schematic.
    * `Bill_of_Materials.csv`: Component list including Manufacturer Part Numbers (MPN).
    * **`EAGLE/`**: Source design files.
        * `.sch`: System Schematic.
        * `.brd`: Board Layout.
        * `.lbr`: Project-specific component library.
    * **`MFG/`**: Manufacturing files.
        * Contains Gerber files (CAM output) generated for fabrication.
    * **`docs/`**: Visual documentation.
        * Mechanical Block Diagram.
        * Top and Bottom layer rendering screenshots.
